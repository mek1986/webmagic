 ...
 * @author 
 */
public class TdtOption implements Serializable {
    private String id;
    ...
    public boolean equals(Object that) {
        ...
        TdtOption other = (TdtOption) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getObjName() == null ? other.getObjName() == null : this.getObjName().equals(other.getObjName()))
            && (this.getObjDesc() == null ? other.getObjDesc() == null : this.getObjDesc().equals(other.getObjDesc()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getObjDesc() == null) ? 0 : getObjDesc().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", objDesc=").append(objDesc);
